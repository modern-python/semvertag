...
test-ci:
    uv run --no-sync pytest --cov=semvertag --cov=tests._descriptor_gate --cov-report term-missing --cov-report xml

test-branch:
    @just test --cov=semvertag --cov=tests._descriptor_gate --cov-branch
